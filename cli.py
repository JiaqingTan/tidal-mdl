#!/usr/bin/env python3
"""
Tidal DL CLI - Main Command Line Interface
A beautiful, feature-rich Tidal media downloader
"""
...
def show_help():
    """Show help message"""
    help_text = """
[bold cyan]🎵 Tidal DL CLI Commands[/bold cyan]
...
def main(config_path: Optional[str], force_login: bool, quality: Optional[str], download_url: Optional[str]):
    """
    🎵 Tidal DL CLI - A beautiful Tidal media downloader
